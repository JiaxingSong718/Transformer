...
class EmbeddingwithPosition(nn.Module):
    def __init__(self, vocab_size, embedding_size, dropout=0.1, seq_max_len=5000) -> None:
        super().__init__()
...
# position_idx = torch.arange(0, 10 ,dtype=torch.float).unsqueeze(-1) #(5000) -> (5000, 1)  [0, 1, 2, 3,....,4999] -> [[0], [1], [2], [3],...,[4999]]
# position_embedding_fill = position_idx * torch.exp(-torch.arange(0, 12, 2) * math.log(10000.0)/12) #
# position_encoding = torch.zeros(10, 12)
# position_encoding[:,0::2] = torch.sin(position_embedding_fill)
# position_encoding[:,1::2] = torch.cos(position_embedding_fill)
