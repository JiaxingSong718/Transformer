...
class MultiHeadAttention(nn.Module):
    ...
    def forward(self, x_q, x_k_v, attention_mask):
        ...
        # 注意力分值处理
        # attention_mask:(batch_size,seq_max_len,seq_max_len)
        attention_mask = attention_mask.unsqueeze(1).expand(-1, self.head, -1, -1) #(batch_size,head,seq_max_len,seq_max_len) expand表示将维度升到head,-1表示不变
